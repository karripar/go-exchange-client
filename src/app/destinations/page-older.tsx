...
import {
  ...
  useDestinationUrls,
} from "@/hooks/destination-hooks/destinationUrlHooks";
...
const DestinationsPage = () => {
  ...
  const translations: Record<string, Record<string, string>> = {
      ...
      findDestinations:
        "Löydät Metropolian vaihtokohteet alla olevista linkeistä aloittain:",
    },
    en: {
      ...
      findDestinations:
        "You can find Metropolia's exchange destinations from the links below by fields of study:",
    },
  };
