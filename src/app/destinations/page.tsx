"use client";
import { useDestinationData } from "@/hooks/destination-hooks/destinationHooks";
...
import { useDestinationUrls } from "@/hooks/destination-hooks/destinationUrlHooks";
...
const DestinationsPage = () => {
  ...
  const translations: Record<string, Record<string, string>> = {
      ...
      checkAllDestinations:
        "Voit varmistaa kohteet niiden niiden varsinaisten URL-osoitteiden kautta.",
    },
    en: {
      ...
      business: "Business",
      checkAllDestinations:
        "You can verify the destinations through their actual URLs.",
    },
  };
